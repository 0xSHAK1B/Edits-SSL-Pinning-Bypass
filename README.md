...
# 🔓 Edits Android SSL Pinning Bypass

#### Intercept, capture & analyze Edits (by Instagram) HTTPS traffic on Android — no root required

<br>

[![Download APK](https://img.shields.io/badge/⬇_Download_APK_(v442.1.0)-C13584?style=for-the-badge&logoColor=white)](../../releases/latest)
...
![Version](https://img.shields.io/badge/Edits-v442.1.0.48.79-C13584?style=flat-square)
...
> **Bypass SSL/TLS certificate pinning** in Edits (Instagram's video editor) for Android and pipe the full HTTPS stream into **Burp Suite · mitmproxy · Reqable · Proxypin.**
...
<img width="578" height="1280" alt="Edits Android SSL Pinning Bypass PoC – Traffic Captured" src="https://github.com/user-attachments/assets/0be71dd9-0dd1-45e7-983f-1bad23117735" />

> Live capture — Edits Android HTTPS traffic intercepted in cleartext. **v442.1.0.48.79**.
...
|-----|---------|:-------:|:---:|:------:|
| Edits (by Instagram) for Android | `com.instagram.basel` | **442.1.0.48.79** | `arm64-v8a` | ✅ [**Download**](../../releases/latest) |
...
Full visibility into the Edits app's traffic (Meta / Instagram backend):

- **Login & authentication** — Instagram-account sign-in and session tokens
- **Project & asset sync** — draft/project data and cloud-stored assets
- **Media upload & export** — clip upload and render/export requests
- **API & configuration** — feature flags and A/B assignments
- **Media & CDN** — asset delivery endpoints
- **Analytics & telemetry** — usage and device telemetry
...
1. **Uninstall** the official Edits app (signatures conflict)
...
6. **Launch Edits** — decrypted HTTPS requests and responses stream into your proxy in real time
